...
extern int Openfile (const mchar* file_name, mchar* file_content);
...
extern int load_all_objects (const mchar* filename); // load all graphs and cameras from a file
...
extern int load_file (const mchar* filename); // load a file into entry text field
...
extern int get_name_from_path_name (mchar* file_name, const mchar* file_path_name);
