...
extern void i86_pit_send_command (uint8b cmd);

// write data byte to a counter
extern void i86_pit_send_data (uint16b data, uint8b counter);

// reads data from a counter
extern uint8b i86_pit_read_data (uint16b counter);

// Sets new pit tick count and returns prev. value
extern uint32b i86_pit_set_tick_count (uint32b i);

// returns current tick count
extern uint32b i86_pit_get_tick_count ();
